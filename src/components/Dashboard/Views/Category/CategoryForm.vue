  ...
  <form @submit.prevent="$emit('submitAction', item)">
    <div class="form-group row">
      <label class="col-4 col-form-label"
        >{{ $t("common.category.input.name") }} :</label
      >
      <div class="col-8">
        <input
          v-model="item.name"
    ...
    <div class="form-group row">
      <label class="col-4 col-form-label"
        >{{ $t("common.category.input.code") }} :</label
      >
      <div class="col-8">
        <input
          v-model="item.code"
    ...
    <div class="form-group row">
      <label class="col-4 col-form-label"
        >{{ $t("common.category.input.sort_order") }} :</label
      >
      <div class="col-8">
        <input
    ...
    <div v-show="isAdmin()" class="form-group row">
      <label class="col-4 col-form-label"
        >{{ $t("common.category.input.parent") }} :</label
      >
      <div class="col-8">
        <treeselect
    ...
    <div class="form-group row">
      <label class="col-4 col-form-label"
        >{{ $t("common.category.input.status") }} :</label
      >
      <div class="col-8">
        <div class="mt-2">
          <switches
    ...
    <div v-if="item && item.user">
      ...
      <div :class="rowClass">
        ...
        <div :class="colSecondClass">
          {{
            item.parent && item.parent.created_at
              ? getDate(item.parent.created_at)
              : ""
          }}
        </div>
      </div>

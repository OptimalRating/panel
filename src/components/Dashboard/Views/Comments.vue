...
export default {
    ...
    return {
      ...
      datatable: {
        columns: [
          ...
          {
            title: this.$t("common.comments.datatable.user"),
            field: "user.email",
            tdComp: TableCustomColumn,
          },
          {
            title: this.$t("common.comments.datatable.comment"),
            field: "body",
            tdComp: TableCustomColumn,
          },
          {
  ...
  methods: {
    getAllComments() {
      ...
      this.loading = true;
      this.$store
        .dispatch("definition/getAllComments", { filter: filter })
        .then((response) => {
          this.loading = false;
      ...
      this.$modal.show("dialog", {
        ...
        buttons: [
          ...
          },
          {
            ...
            handler: () => {
              this.$store
                .dispatch("definition/deleteComment", { data: item })
                .then(() => {

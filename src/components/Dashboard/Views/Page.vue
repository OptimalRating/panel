    ...
    return {
      ...
      datatable: {
        columns: [
          ...
          {
            title: this.$t("common.page.datatable.title"),
            field: "title",
            tdComp: TableCustomColumn,
          },
          {
            title: this.$t("common.page.datatable.order"),
            field: "order",
            tdComp: TableCustomColumn,
          },
          {
...
>>>>>>> Stashed changes
  ...
  methods: {
    getAllPages() {
      ...
      this.loading = true;
      this.$store
        .dispatch("definition/getAllPages", { filter: filter })
        .then((response) => {
          this.loading = false;
      ...
      this.$modal.show("dialog", {
        ...
        buttons: [
          ...
          },
          {
            ...
            handler: () => {
              this.$store
                .dispatch("definition/deletePage", { data: item })
                .then(() => {
    ...
    savePage() {
      if (this.mode === "save") {
        this.$store
          .dispatch("definition/createPage", { data: this.page })
          .then((response) => {
            this.getAllPages();
        ...
        this.$store
          .dispatch("definition/updatePage", {
            id: this.page.id,
            data: this.page,
          })
          .then((response) => {
